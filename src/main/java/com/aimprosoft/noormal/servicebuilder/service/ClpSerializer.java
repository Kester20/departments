...
import com.aimprosoft.noormal.servicebuilder.model.DepartmentClp;
import com.aimprosoft.noormal.servicebuilder.model.EmployeeClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "departments-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "departments";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.aimprosoft.noormal.servicebuilder.model.impl.DepartmentImpl")) {
        ...
        if (oldModelClassName.equals(
                    "com.aimprosoft.noormal.servicebuilder.model.impl.EmployeeImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals(
                    "com.aimprosoft.noormal.servicebuilder.NoSuchDepartmentException")) {
            return new com.aimprosoft.noormal.servicebuilder.NoSuchDepartmentException();
        }

        if (className.equals(
                    "com.aimprosoft.noormal.servicebuilder.NoSuchEmployeeException")) {
            return new com.aimprosoft.noormal.servicebuilder.NoSuchEmployeeException();
        }
