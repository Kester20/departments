...
<table class="table" cellpadding="10" border="1" align="center">
    ...
    <c:forEach var="employee" items="${employees}">
        ...
        <tr>
            ...
            <td>
                <a href="employee_controller?action=/getEditEmployeePage&employeeId=${employee.id}&departmentId=${departmentId}&getPage=true}">Edit</a>
            </td>
        ...
        <tr>
            ...
            <td colspan="2"><a href="">Add new Employee</a></td>
        </tr>
